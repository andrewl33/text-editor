...
describe("update code", () => {
  ...
  test("it should handle UPDATE_CODE_REQUEST", () => {
    expect(editorReducer(undefined, { type: UPDATE_CODE_REQUEST })).toEqual(
      updatedCodeRequest
    );
  });

  test("it should handle UPDATE_CODE_SUCCESS", () => {
    expect(editorReducer(undefined, { type: UPDATE_CODE_SUCCESS })).toEqual(
      updatedCodeSuccess
    );
  });

  test("it should handle UPDATE_CODE_FAILURE", () => {
    expect(editorReducer(undefined, { type: UPDATE_CODE_FAILURE })).toEqual(
      updatedCodeFailure
    );
  });
});
...
describe("get text", () => {
  ...
  test("it should handle GET_TEXT_REQUEST", () => {
    expect(editorReducer(undefined, { type: GET_TEXT_REQUEST })).toEqual(
      request
    );
  });

  test("it should handle GET_TEXT_SUCCESS", () => {
    expect(editorReducer(undefined, { type: GET_TEXT_SUCCESS })).toEqual(
      success
    );
  });

  test("it should handle GET_TEXT_FAILURE", () => {
    expect(editorReducer(undefined, { type: GET_TEXT_FAILURE })).toEqual(
      failure
    );
  });
});
...
describe("new text", () => {
  ...
  test("it should handle NEW_TEXT_REQUEST", () => {
    expect(editorReducer(undefined, { type: NEW_TEXT_REQUEST })).toEqual(
      request
    );
  });

  test("it should handle NEW_TEXT_SUCCESS", () => {
    expect(editorReducer(undefined, { type: NEW_TEXT_SUCCESS })).toEqual(
      success
    );
  });

  test("it should handle NEW_TEXT_FAILURE", () => {
    expect(editorReducer(undefined, { type: NEW_TEXT_FAILURE })).toEqual(
      failure
    );
  });
});
...
describe("EditorReducer: local actions", () => {
  test("it should handle CLOSE_ALERT", () => {
    expect(editorReducer(undefined, { type: CLOSE_ALERT })).toEqual({
      ...initialState,
      openAlert: false
    });
  });
