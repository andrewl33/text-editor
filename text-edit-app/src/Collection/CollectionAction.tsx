...
export interface NewCollection {
  type: NEW_COLLECTION_REQUEST | NEW_COLLECTION_SUCCESS | NEW_COLLECTION_FAILURE; 
  payload?: boolean;
}

export interface GetCollection {
  type: GET_COLLECTION_REQUEST | GET_COLLECTION_SUCCESS | GET_COLLECTION_FAILURE;
  payload?: {
    success: boolean;
...
export interface AuthCollection {
  type: AUTH_COLLECTION_REQUEST | AUTH_COLLECTION_SUCCESS | AUTH_COLLECTION_FAILURE;
  payload?: {
    success: boolean; 
    message: string;
  };
...
export interface LockCollection {
  type: LOCK_COLLECTION_REQUEST | LOCK_COLLECTION_SUCCESS | LOCK_COLLECTION_FAILURE;
  payload?: boolean;
}
...
export type CollectionAction = NewCollection | GetCollection | AuthCollection | LockCollection | AddFile | RemoveFile | ShareLink | CloseAlert;

export const newCollection = () => {

  return async (dispatch: ThunkDispatch<StoreState, void, NewCollection | RouterAction>) => {
...
export const getCollectionFiles = () => {
  ...
  return async (dispatch: ThunkDispatch<StoreState, void, GetCollection>, getState: () => StoreState) => {
...
export const lockCollection = (password: string) => {
  return async (dispatch: ThunkDispatch<StoreState, void, LockCollection>, getState: () => StoreState) => {
