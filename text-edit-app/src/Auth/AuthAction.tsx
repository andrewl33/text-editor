...
import { StoreState, DashboardProps } from '../types';

export interface CreateAccount {
  type: CREATE_ACCOUNT_REQUEST | CREATE_ACCOUNT_SUCCESS | CREATE_ACCOUNT_FAILURE;
  payload?: {success: boolean, accountName: string};
}

export interface LogIn {
  type: LOG_IN_REQUEST | LOG_IN_SUCCESS | LOG_IN_FAILURE;
  payload?: {success: boolean, accountName: string, dashboard?: DashboardProps};
}
